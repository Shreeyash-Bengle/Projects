...
void man(char *name)
{
    ...
    if(strcmp(name,"create") == 0)
    {
        ...
        // We can Add more description about command here
    }
    ...
    {
        printf("Description : Used to close a particular file\n");
...
void DisplayHelp()
{
    ...
    printf("write    : To write the contents into a file\n");
    printf("exit     : To terminate the file system\n");
    printf("stat     : To display the information of a file using name\n");
    printf("fstat    : To display the information of a file using file descriptor\n");
    printf("truncate : To remove all the data from a file\n");
